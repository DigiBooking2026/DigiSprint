...
const templates = [
  {
    ...
    tasks: [
      ...
      { title: "Build responsive pricing section", status: "In Progress", points: 6, due: 4, assignee: 1 },
      { title: "Review header navigation", status: "Review", points: 2, due: 2, assignee: 0 },
  ...
  },
  {
    ...
    tasks: [
      { title: "Fix invoice sync retry bug", status: "In Progress", points: 8, due: -4, assignee: 2, type: "BUG", category: "Backend" },
      { title: "Add task history audit coverage", status: "Testing", points: 5, due: -1, assignee: 3, category: "Testing" },
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: "Verify payment error states", status: "Done", points: 3, due: -8, assignee: 3, type: "BUG", category: "Testing" },
